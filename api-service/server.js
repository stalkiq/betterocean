...
function buildInstantTickerReport(symbol) {
  const profile = COMPANY_PROFILE_OVERRIDES[symbol]
    ? {
        ...COMPANY_PROFILE_OVERRIDES[symbol],
        updatedAt: new Date().toISOString(),
      }
...
function buildTickerReportFallback(symbol, quote, news, companyProfile = null) {
  ...
  return {
    ...
    signal,
    confidence: "medium",
    overview: companyProfile?.summary || `${getCompanyLookupName(symbol)} summary is being generated by Gradient AI.`,
    bullishFactors:
      signal === "bullish"
    ...
    companyProfile: companyProfile || {
      ...
      description: "",
      summary: `${getCompanyLookupName(symbol)} summary is being generated by Gradient AI.`,
      source: "fallback",
      updatedAt: new Date().toISOString(),
    },
    gradientSuggestion: {
    ...
    agentPanels: {
      company: companyProfile?.summary
        ...
        : [`Gradient AI is generating a best-effort company overview for ${getCompanyLookupName(symbol)}.`],
